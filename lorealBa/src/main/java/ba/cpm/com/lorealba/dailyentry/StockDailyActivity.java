...
public class StockDailyActivity extends AppCompatActivity implements StockFragment.OnFragmentInteractionListener {
  ...
  //  int[] iconarray = {R.drawable.makeup, R.drawable.skin_care, R.drawable.hair, R.drawable.lip_icon_grey, R.drawable.eyes_icon};
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
         ...
         //   return StockFragment.newInstance(productMasters.get(position).getAxeName());
            return StockFragment.newInstance(productMasters,position);
        }
    ...
    private void addTab(int id) {
        ...
        View customView = LayoutInflater.from(StockDailyActivity.this).inflate(R.layout.tab_icon_lay, null);
