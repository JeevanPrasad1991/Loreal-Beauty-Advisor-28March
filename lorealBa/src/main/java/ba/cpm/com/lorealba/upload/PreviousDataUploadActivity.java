package ba.cpm.com.lorealba.upload;
...
import ba.cpm.com.lorealba.retrofit.PostApiForUpload;
...
public class PreviousDataUploadActivity extends AppCompatActivity {
    ...
    public void uploadDataUsingCoverageRecursive(ArrayList<CoverageBean> coverageList, int coverageIndex) {
        try {
            ...
            if (status.equalsIgnoreCase(CommonString.KEY_C) || status.equalsIgnoreCase(CommonString.KEY_P) || !status.equalsIgnoreCase(CommonString.KEY_D)) {
