...
import ba.cpm.com.lorealba.gsonGetterSetter.JourneyPlanSearch;
...
public class JourneyPlanSearchActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public class ValueAdapter extends RecyclerView.Adapter<ValueAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(final MyViewHolder viewHolder, final int position) {
            ...
            viewHolder.txt.setText("Store Id - " + current.getStoreId() + "\n" + current.getStoreName() + " - " +
                    current.getClassification());
            viewHolder.txt_storeAddress.setText(current.getAddress1() + " - " + current.getCity());
