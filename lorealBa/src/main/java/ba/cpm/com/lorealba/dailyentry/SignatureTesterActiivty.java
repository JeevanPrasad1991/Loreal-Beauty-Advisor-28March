...
public class SignatureTesterActiivty extends AppCompatActivity {
    ImageView loreal_paris,maybelline;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_signature_tester_actiivty);
        ...
        loreal_paris.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SignatureTesterActiivty.this, TesterActivity.class).putExtra(CommonString.KEY_SIGNETURE_ID,"1"));
        ...
        maybelline.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SignatureTesterActiivty.this, TesterActivity.class).putExtra(CommonString.KEY_SIGNETURE_ID,"2"));
                overridePendingTransition(R.anim.activity_in, R.anim.activity_out);
            }
        });
    }
