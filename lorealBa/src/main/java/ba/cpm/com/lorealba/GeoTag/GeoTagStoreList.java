...
public class GeoTagStoreList extends AppCompatActivity {
    ...
    public class ValueAdapter extends RecyclerView.Adapter<ValueAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(final MyViewHolder viewHolder, final int position) {
            ...
            if (current.getGeoTag().equalsIgnoreCase("Y")) {
                ...
                viewHolder.imageview.setBackgroundResource(R.mipmap.geotag_grey_done);
            } else if (current.getGeoTag().equalsIgnoreCase(CommonString.KEY_N)) {
    ...
    void declaration() {
        ...
        db = new Lorealba_Database(GeoTagStoreList.this);
        db.open();
    }
